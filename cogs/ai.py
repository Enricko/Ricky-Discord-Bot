...
class Ai(commands.Cog, name="AI"):
    ...
    @commands.hybrid_command(
        name="ai",
        description="Using an AI named Ricky the Cats he will answer all your question.",
    )
    async def ai_reply(self, context: Context, *, message) -> None:
        messages = [
        ...
        embed = discord.Embed(
            title="Ricky The Cat Answer :cat: : ",
            description=f"{reply}",
            color=0xBEBEFE,
        )
